...
//3.3v  ------  Vc
//gnd   ------  gnd
//The Pins PF1 and PF2 control one wheel and the Pins PF3 and PF4 control the other wheel
//Outputs of these pins are connected to the LM293N Motor Driver
...
#define greenhLED      (*((volatile uint32_t *)(0x42000000 + (0x400253FC-0x40000000)*32 + 4*4)))
